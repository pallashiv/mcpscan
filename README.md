...
[![CI](https://github.com/pallashiv/mcpscan/actions/workflows/ci.yml/badge.svg)](https://github.com/pallashiv/mcpscan/actions/workflows/ci.yml)
...
src/mcpscan/
  ...
  lock.py      Rug-pull detection (--lock/--write-lock)
  cli.py       argparse entrypoint
action.yml     GitHub Action (composite); scripts/run-scan.sh is its scan step
site/          The live demo (GitHub Pages): index.html is hand-written, site/examples/ is
               generated by scripts/build_demo_site.py and gitignored
